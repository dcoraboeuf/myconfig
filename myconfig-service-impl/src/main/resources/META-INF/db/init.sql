...
CREATE TABLE VERSION_KEY (
	...
	CONSTRAINT FK_VERSION_KEY_KEY FOREIGN KEY (APPLICATION, KEY) REFERENCES APPKEY (APPLICATION, NAME) ON DELETE CASCADE
);
...
CREATE TABLE CONFIG (
	...
	CONSTRAINT FK_CONFIG_KEY FOREIGN KEY (APPLICATION, KEY) REFERENCES APPKEY (APPLICATION, NAME) ON DELETE CASCADE,
