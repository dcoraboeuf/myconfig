...
public class TestGetApplications extends AbstractSecurityTest {
	...
	public void admin() throws SQLException {
		...
		assertNotNull(list);
		assertEquals (asList(
				new ApplicationSummary(1, "app1", 0, 0, 0, 0, 0, true, true, true),
				new ApplicationSummary(2, "app2", 0, 0, 0, 0, 0, true, true, true)
				), list);
	}
	...
	public void app_list_no_grant() throws SQLException {
		...
		assertNotNull(list);
		assertEquals (asList(
				new ApplicationSummary(1, "app1", 0, 0, 0, 0, 0, false, false, false),
				new ApplicationSummary(2, "app2", 0, 0, 0, 0, 0, false, false, false)
				), list);
	}
	...
	public void app_list_some_grant() throws SQLException {
		...
		assertEquals (asList(
				new ApplicationSummary(1, "app1", 0, 0, 0, 0, 0, false, false, false),
				new ApplicationSummary(2, "app2", 0, 0, 0, 0, 0, false, false, true)
				), list);
	}
	...
	public void app_view_no_other_grant() throws SQLException {
		...
		assertNotNull(list);
		assertEquals (asList(
				new ApplicationSummary(1, "app1", 0, 0, 0, 0, 0, false, false, true)
				), list);
	}
	...
	public void app_view_and_config() throws SQLException {
		...
		assertNotNull(list);
		assertEquals (asList(
				new ApplicationSummary(1, "app1", 0, 0, 0, 0, 0, false, true, true)
				), list);
	}
